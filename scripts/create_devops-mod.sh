...
column GROUP_REIMB_DEF_GPS_ID format 999999999999.9
...
column TOP_JOB_ID format 999999999999.9
...
QUERY="select BILL_TYPE, DEFINITION_TYPE, DISCHARGE_DATE_REPLACEMENT_ID, GPCS_CONTENT_VERSION_ID, GPCS_GRP_SCHED_USERKEY1, GPCS_GRP_SCHED_USERKEY2, GPCS_REIMB_SCHED_USERKEY1, GPCS_REIMB_SCHED_USERKEY2, GR_UB_STANDALONE_VERSION_ID, GROUPING_STORAGE_TYPE_ID, HAC_PROCESSING_TYPE, HISTORY_ID, ICD_VERSION_QUALIFIER, IS_SAMPLE_APPLY, MOD_CONTRACT_NAME, MOD_GRP_SCHED_ID, MOD_GRP_TYPE_ID, MOD_REIM_SCHED_ID, MOD_VERS_NUM, NAME, OWNER_ID, PMOD_TRUNCATE_VERSION, PREF_AUDIT_ONLY, PREF_AUDIT_TYPE, PREF_CNVT_BIRTH_WT, PREF_EAPG_EDIT_OPTION, PREF_ENC_PROC_FOR_DUPS, PREF_IS_CLAIM_STORAGE, PREF_IS_GRP_OUT_OF_DATE, PREF_IS_REIM_OUT_OF_DATE, PREF_NO_ZERO_CHARGES, PREF_OVERRIDE_BILL_TYPE, PREF_PMOD_CLAIM_ID_SOURCE, PREF_POLLING_TIME, PREF_REM_CLAIM_ID_SOURCE, PREF_REM_INCLUDE_UNDER_DEV, PREF_REM_SEND_COVERED, PREF_REM_SEND_EVENT_DATA, PREF_REM_SEND_POP_DATA, PREF_REM_SITEM_TYPE, PREF_RESERVATION_TYPE, PREF_SEND_COINSUR_AND_DEDUCT, PREF_SEND_MEDICARE_RX_QTY, PREF_SEND_TOT_CHGS_AS_COVERED, PREF_SITEM_TO_PMOD, PROCESS_TYPE_ID, REM_PRODUCT, REM_RATE_SCHEDULE, UNIQUE_ID, USER_SUPPLIED_DISCHARGE_DATE from support.${TABLENAME}"
$ORACLE_HOME/bin/sqlplus -s / as sysdba << SCRIPT > $LOGDIR/$TABLENAME.txt
    $SQLPLUS_CFG
    ${QUERY};
SCRIPT
